...
export default function CallToAction() {
  return (
    <div className="mx-auto mt-8 flex max-w-screen-xl flex-col items-center gap-8 p-4 sm:flex-row lg:p-8 sm:mt-10">
      ...
      <div className="grid flex-1 justify-items-center sm:justify-items-start gap-2">
        <h1 className=" px-4 text-center text-2xl sm:text-left">
          Take the next step toward your personal and professional goals with
          Learn.
        </h1>
        <p className="px-4 mt-2 mb-4 text-center text-foreground/80 sm:mb-6 sm:text-left">
